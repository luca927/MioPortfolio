...
export default function Navabar() {
    ...
    return (
        <>
            <nav>
                <a href="#hero" className="nav-logo">LC</a>
                ...
                <div className="nav-contacts">
                    <a href="mailto:casaloneluca7@gmail.com" className="btn-contact">Contattami</a>
                ...
                {/* Il tasto hamburger ora usa la funzione di React */}
                <button className="hamburger" onClick={toggleMenu} aria-label="Menu">
                    {isOpen ? '✕' : '☰'}
                </button>
            </nav>

            {/* Menu Mobile: appare solo se isOpen è true */}
            <div id="mobileMenu" className={`mobile-menu ${isOpen ? 'active' : ''}`}>
